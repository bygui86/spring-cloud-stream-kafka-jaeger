...
@Slf4j
@Configuration("sourceTracingConfig")
// @AutoConfigureAfter(SourceSchedulingConfig.class)
public class SourceTracingConfig {
	...
	protected Map<String, Object> kafkaProducerConfigs() {
		...
		props.put(ProducerConfig.CLIENT_ID_CONFIG, "source");
