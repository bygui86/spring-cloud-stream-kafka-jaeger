...
@Slf4j
@Configuration("sinkTracingConfig")
// @AutoConfigureAfter(SinkStreamConfig.class)
public class SinkTracingConfig {
	...
	protected Map<String, Object> kafkaConsumerConfigs() {
		...
		props.put(ConsumerConfig.GROUP_ID_CONFIG, "timestamp-sinks");
